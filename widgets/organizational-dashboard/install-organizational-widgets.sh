#!/bin/bash
# Install Organizational Contribution Dashboard Widgets to MISP
# Created: 2025-10-16
...
echo "======================================"
echo "Installing Organizational Dashboard Widgets"
echo "======================================"
echo ""
...
WIDGETS=(
    ...
    "SubsectorContributionWidget.php"
...
echo ""
echo "======================================"
echo "✓ All 5 Organizational widgets installed!"
echo "======================================"
echo ""
echo "Installed widgets:"
echo "  1. ISACContributionRankingsWidget (BarChart)"
echo "  2. SectorSharingMetricsWidget (SimpleList)"
echo "  3. RegionalCooperationHeatMapWidget (WorldMap)"
echo "  4. SubsectorContributionWidget (BarChart)"
echo "  5. MonthlyContributionTrendWidget (MultiLineChart)"
echo ""
echo "Next steps:"
